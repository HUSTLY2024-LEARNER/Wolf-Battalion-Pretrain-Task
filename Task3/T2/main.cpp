 ...
 string image_file = "/mnt/c/Users/86153/Desktop/RM/Task_3/scr/distorted.png"; // 请 确 保 路 径 正 确
 ...
 double x = (u - cx) / fx;
 double y = (v - cy) / fy;  //像素点对应的真实图像中的那个点距离光心的横纵坐标
 double r = sqrt(x * x + y * y);  //该点到中心的距离
 double x_distorted = x * (1 + k1 * r* r + k2 * r * r * r * r) + 2 * p1 * x * y + p2 * (r * r + 2 * x * x);
 double y_distorted = y * (1 + k1 * r*r + k2 * r * r * r *r) + 2 * p1 * (r * r + 2 * y * y) + 2 * p2 * x * y;
